...
# called student_grades that should contain student names for keys and their grades for values. The final version
...
# Scores 81 - 81: Grade = "Exceeds Expectations"
...
for key in student_scores:
    ...
    elif 81 <= int(student_scores[key]) <= 81:
